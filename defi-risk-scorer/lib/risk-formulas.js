 ...
 */
export function computeHHI(balancesUSD) {
...
export function normalizedHHI(balancesUSD) {
 ...
 */
export function estimateSlippage(reserveIn, reserveOut, tradeSizeIn) {
...
export function slippageCurve(reserveIn, reserveOut, tradeSizes) {
 ...
 */
export const TOKEN_PRICE_TABLE = {
 ...
 */
export function rawAmountToUSD(rawAmount, tokenAddress) {
 ...
 */
export function uniswapV3ToBalancesUSD(positionsResponse, currentTick) {
 ...
 */
export function balancerToBalancesUSD(poolResponse) {
 ...
 */
export function curveToBalancesUSD(depositsResponse, withdrawsResponse, poolTokenAddresses, poolsToExclude = []) {
  const netByAddress = {};
 ...
 */
export async function fetchAllCurveEvents(gatewayUrl, poolId, eventType, maxPages = 20) {
  const allEvents = [];
 ...
 */
export async function fetchFullCurveHistory(gatewayUrl, poolId, maxPages = 20) {
